	...
	<div align="center">
		<form action="UpdateProduct" method="post">
        	...
        	<table border="1" cellpadding="5">
        		...
        		<tr>
           			<th>Name Product: </th>
           			<td><input type="text" name="name_product" value="<c:out value="${PRODUCT.name_product}"/>"/></td>
				</tr>
				<tr>
           			<th>Producer: </th>
           			<td>
           		...
           		<tr>
           			<th>Price Sale: </th>
           			<td><input type="text" name="price_sale" value="<c:out value="${PRODUCT.price_sale}"/>"></td>
           		</tr>
           		<tr>
           			<th>Image: </th>
           			<td><input type="text" name="image" value="<c:out value="${PRODUCT.image}"/>"></td>
           		</tr>
           		<tr>
           			<th>Describe: </th>
           			<td><input type="text" name="describe" value="<c:out value="${PRODUCT.describe}"/>"></td>
       	    	</tr>
       	     	<tr>
    	            <td></td>
